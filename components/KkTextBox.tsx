...
export default function KkTextBox({
  ...
  const borderColor = hasError ? "#F6623B" : isActive ? "#F6623B" : "#A49289";
  ...
  return (
    <View style={style}>
      ...
      <View style={styles.row}>
        ...
        {rightButton && <View style={styles.buttonWrapper}>{rightButton}</View>}
      </View>
      {isActive && hasError && <Text style={styles.errorText}>{error}</Text>}
    </View>
  );
}
