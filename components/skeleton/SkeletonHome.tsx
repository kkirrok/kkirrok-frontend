...
function SkeletonProfileCard() {
  return (
    <View style={styles.card}>
      <SkeletonBox width="40%" height={22} borderRadius={8} style={styles.center} />
      <SkeletonBox width="30%" height={20} borderRadius={8} style={[styles.center, { marginTop: 8 }]} />
    </View>
  );
}
...
function SkeletonNutrientCard() {
  return (
    <View style={styles.card}>
      {[0, 1, 2, 3, 4].map((i) => (
        <View key={i} style={[styles.nutrientRow, i < 4 && { marginBottom: 8 }]}>
          <SkeletonBox width="20%" height={16} borderRadius={6} />
          <SkeletonBox width={undefined} height={20} borderRadius={8} style={styles.barFlex} />
...
export default function SkeletonHome() {
  return (
    <View style={styles.container}>
      ...
      {/* 섹션 타이틀 */}
      <SkeletonBox width={120} height={20} borderRadius={8} style={{ marginTop: 16 }} />

      {/* 영양성분 카드 */}
      <SkeletonNutrientCard />

      {/* 피드백 섹션 타이틀 */}
      <SkeletonBox width={100} height={20} borderRadius={8} style={{ marginTop: 16 }} />
